...
//        // using 'join fetch' because a single query should load both owners and pets
//        // using 'left join fetch' because it might happen that an owner does not have pets yet
//        Query query = this.em.createQuery("SELECT DISTINCT ownerLW FROM OwnerLW ownerLW left join fetch ownerLW.petsLW ");
//        return query.getResultList();
//    }
    ...
    public Collection<Owner> findAll() {
        // using 'join fetch' because a single query should load both owners and pets
        // using 'left join fetch' because it might happen that an owner does not have pets yet
        Query query = this.em.createQuery("SELECT DISTINCT owner FROM Owner owner left join fetch owner.pets left join"
    ...
    public Owner findById(int id) {
        // using 'join fetch' because a single query should load both owners and pets
        // using 'left join fetch' because it might happen that an owner does not have pets yet
        Query query = this.em.createQuery("SELECT owner FROM Owner owner left join fetch owner.pets left join fetch owner.ownerImage WHERE owner.id =:id");
